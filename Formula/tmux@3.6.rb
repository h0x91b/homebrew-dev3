class TmuxAT36 < Formula
  ...
  # Pinned pre-3.7 tmux: 3.7/3.7a/3.7b command clients busy-spin at 100% CPU
  # (imsgbuf_flush -> sendmsg) whenever the tmux server is briefly busy,
  # starving the server and freezing the machine under dev3's pollers.
